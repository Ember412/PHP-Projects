...
<head>
    ...
    <title>Home Page:Embery Doughnuts Online Delievery Service</title>
    <!--
    ...
    <div class="" id="home">
        <div class="container">
            ...
            <div class="row tm-content-row tm-mt-small">
                <div class="col-xl-5 col-lg-12 tm-md-12 tm-sm- tm-col">
                    <div class="bg-white tm-block h-1">
                        <h2 class="">Hello Welcome Admin!!</h2>
