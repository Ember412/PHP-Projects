...
<head>
    ...
    <title>View Page:Embery Doughnuts Online Delievery Service</title>
    <!--
        ...
        <div class="container">
                    ...
                    <nav class="navbar navbar-expand-xl navbar-light bg-light">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="view-order.php">View Order</a>
                                </li>
                                <li class="nav-item">
            ...
            <div class="row tm-content-row tm-mt-big">
                <div class="col-xl-15 col-lg-12 tm-md-12 tm-sm-12 tm-col">
					...
					<tr><th width="50px" height="50px">ID:</th>					
						<th width="350px" height="50px">Product Name:</th>
						<th width="150px" height="50px">Price:</th>
						<th width="200px" height="50px">Name:</th>
						<th width="200px" height="50px">Phone:</th>
						<th width="200px" height="50px">Address:</th>	
					 ...
					 <tr>
						...
						<td width="70px" height="50px"><?php echo $price; ?></td>
